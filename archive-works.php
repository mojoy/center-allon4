						...
						<div>
							<div class="field--name-field-media-image field--type-image field--label-hidden">
								<picture>
									...
									<img loading="eager" src="https://www.nobelbiocare.com/sites/default/files/styles/hero_mobile_x1_320_x_375/public/website-hero%20copy%202%20%281%29.png.webp?itok=m4pqQ2tw" width="320" height="375" alt="Clinical cases" class="image" loading="lazy" decoding="async">
								</picture>
							</div>
						</div>
					</div>
												...
												<div class="field--name-field-shared-teaser-image field--type-entity-reference field--label-hidden">
													<div>
														<div class="field--name-field-media-image field--type-image field--label-hidden">
															...
															echo '<img src="' . $thumbnail_url . '" width="440" height="280" alt="'. get_the_title() .'" loading="lazy" decoding="async">';
															?>
														</div>
													</div>
												</div>
